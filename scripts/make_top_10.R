...
# print(FDI_SP_L2_dataset_1_disjoint_new)
...
FDI_NB_AA_dataset_2_joint = FDI_NB_AA_dataset_2_joint %>% 
  mutate(col1 = pmin(from, to), col2 = pmax(from, to), 
...
FDI_NB_AA_dataset_2_joint_new <- FDI_NB_AA_dataset_2_joint %>%
  separate(to, c("food_ID", "Compound_ID", "Compound_Name"), "_")
...
FDI_NB_AA_dataset_2_joint_new_unique_food_ID <- FDI_NB_AA_dataset_2_joint_new %>% distinct(food_ID, Compound_Name, .keep_all = TRUE)
FDI_NB_AA_dataset_2_joint_new_unique_food_ID <- FDI_NB_AA_dataset_2_joint_new_unique_food_ID %>% arrange(desc(value))
...
FDI_NB_AA_dataset_2_joint_new_unique_food_ID_compound_ID <- FDI_NB_AA_dataset_2_joint_new_unique_food_ID_compound_ID  %>% arrange(desc(value))

FDI_NB_AA_dataset_2_joint_new_unique_food_ID_compound_ID_top_10 <- FDI_NB_AA_dataset_2_joint_new_unique_food_ID_compound_ID[1:10, c("from", 
                                                                                                                                    "foodID_CompoundID_Compound_Name", 
                                                                                                                                    "value")]
...
print(FDI_NB_CN_dataset_2_joint)
...
print(FDI_NB_CN_dataset_2_joint_new)
FDI_NB_CN_dataset_2_joint_new_unique_food_ID <- FDI_NB_CN_dataset_2_joint_new %>% distinct(food_ID, Compound_Name, .keep_all = TRUE)
FDI_NB_CN_dataset_2_joint_new_unique_food_ID <- FDI_NB_CN_dataset_2_joint_new_unique_food_ID  %>% arrange(desc(value))
...
FDI_NB_CN_dataset_2_joint_new_unique_food_ID_compound_ID <- FDI_NB_CN_dataset_2_joint_new_unique_food_ID_compound_ID %>% arrange(desc(value))

FDI_NB_CN_dataset_2_joint_new_unique_food_ID_compound_ID_top_10 <- FDI_NB_CN_dataset_2_joint_new_unique_food_ID_compound_ID[1:10, c("food_ID", 
                                                                                                                                    "foodID_CompoundID_Compound_Name", 
                                                                                                                                    "value")]
...
print(FDI_NB_L3_dataset_2_joint)
...
print(FDI_NB_L3_dataset_2_joint_new)
FDI_NB_L3_dataset_2_joint_new_unique_food_ID <- FDI_NB_L3_dataset_2_joint_new %>% distinct(food_ID, Compound_Name, .keep_all = TRUE)
FDI_NB_L3_dataset_2_joint_new_unique_food_ID <- FDI_NB_L3_dataset_2_joint_new_unique_food_ID %>% arrange(desc(value))
...
FDI_NB_L3_dataset_2_joint_new_unique_food_ID_compound_ID <- FDI_NB_L3_dataset_2_joint_new %>% 
  distinct(food_ID, Compound_ID, Compound_Name, .keep_all = TRUE)
FDI_NB_L3_dataset_2_joint_new_unique_food_ID_compound_ID <- FDI_NB_L3_dataset_2_joint_new_unique_food_ID_compound_ID %>% arrange(desc(value))

FDI_NB_L3_dataset_2_joint_new_unique_food_ID_compound_ID_top_10 <- FDI_NB_L3_dataset_2_joint_new_unique_food_ID_compound_ID[1:10, c("food_ID", 
                                                                                                                                    "foodID_CompoundID_Compound_Name", 
                                                                                                                                    "value")]
...
print(FDI_NB_RA_dataset_2_joint)
...
FDI_NB_RA_dataset_2_joint_new_unique_food_ID <- FDI_NB_RA_dataset_2_joint_new %>% distinct(food_ID, Compound_Name, .keep_all = TRUE)
FDI_NB_RA_dataset_2_joint_new_unique_food_ID <- FDI_NB_RA_dataset_2_joint_new_unique_food_ID %>% arrange(desc(value))
...
FDI_NB_RA_dataset_2_joint_new_unique_food_ID_compound_ID <- FDI_NB_RA_dataset_2_joint_new %>% 
  distinct(food_ID, Compound_ID, Compound_Name, .keep_all = TRUE)
FDI_NB_RA_dataset_2_joint_new_unique_food_ID_compound_ID <- FDI_NB_RA_dataset_2_joint_new_unique_food_ID_compound_ID 
#%>% arrange(desc(scr))

FDI_NB_RA_dataset_2_joint_new_unique_food_ID_compound_ID_top_10 <- FDI_NB_RA_dataset_2_joint_new_unique_food_ID_compound_ID[1:10, c("food_ID", 
                                                                                                                                    "foodID_CompoundID_Compound_Name", 
                                                                                                                                    "value")]
...
finalCSV <- bind_rows(FDI_SP_L2_dataset_1_disjoint_new_unique_top_10,
